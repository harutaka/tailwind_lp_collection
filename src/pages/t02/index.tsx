...
const T02Index: NextPage = () => {
  return (
    <>
      ...
      <body className="font-meiryo bg-blue-50">
        <main className="mx-auto max-w-[1000px]">
          <h1 className="my-2 mt-12 text-2xl font-bold">PHOTO BOOK</h1>
          ...
          <footer className="my-4 mx-auto w-[600px] text-[10px]">© 2020 PHOTO BOOK</footer>
        </main>
      </body>
    </>
  )
